...
namespace ARDKExamples.Scanning
{
    public class ScanningExampleManager : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("Container holding scanner control buttons.")]
    ...
    [SerializeField] private UrpRaycastScanVisualizer  _raycastScanVisualizer;
        ...
        [SerializeField] private ObjectEditorManager objectEditorManager;
        ...
        private void ShowTexturedMesh(TexturedMesh texturedMesh)
        {
            ...
            Mesh meshWithoutGround = GroundRemover.RemoveGroundPlane(texturedMesh.mesh);
            Bounds meshBoundary = meshWithoutGround.bounds;
            ...
            scannedObject.GetComponent<MeshFilter>().sharedMesh = meshWithoutGround;
            if (texturedMesh.texture != null)
                scannedObject.GetComponent<Renderer>().material.mainTexture = texturedMesh.texture;
            //scannedObject.AddComponent<ObjectSlicerSample>();
            scannedObject.AddComponent<BoxCollider>();
            objectEditorManager.SetEditableObject(scannedObject);
